                    ...
                    <div class="row">
                        <div class="col">
                            <div class="home_content">
                                <div class="home_title">Ayşe'nin Köşesi</div>
                            </div>
                        </div>
                    </div>
                </div>
                     ...
                     @foreach($sayfalar as $sayfa) 
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                            <div style="margin-bottom:10px;" class="card"> 	
                                ...
                                <div class="card-body"> <img style="width:100%;height:120px; " src="/davdav/public/storage/cover_image/{{$sayfa->cover_image}}"> </div>
