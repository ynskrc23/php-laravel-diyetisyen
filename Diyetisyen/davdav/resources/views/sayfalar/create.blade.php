...
<div style="margin-top:15px; margin-left:10px;" class="container-fluid">
    <div class="row content">
      ...
      <div class="well">YAZI İÇERİĞİNİ OLUŞTURMA İŞLEMLERİ</div>
        ...
        {!! Form::open(['action'=>'SayfalarController@store', 'method' =>'POST','enctype' =>'multipart/form-data']) !!}
        <p>
            {{Form::label('sayfa_adi', 'Sayfa Adi')}}
            {{Form::text('sayfa_adi', '',['class' =>'w3-input w3-border' ,'placeholder'=> 'Lütfen Sayfa Adını Giriniz'])}}          
        </p> <br>
              
        <p>
            {{Form::label('sayfa_icerik', 'İçerik')}}
            {{Form::textarea('sayfa_icerik', '',['id' => 'article-ckeditor', 'class' =>'form-control'  ,'placeholder'=> 'Lütfen İçerik Adını Giriniz'])}}  
        ...
        {{Form::submit('Ekle',['class' =>'btn btn-primary btn-md'])}}  
    </div>
        {!! Form::close() !!}
